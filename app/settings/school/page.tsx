...
async function saveSchool(formData: FormData) {
  ...
  await updateSchool({
    ...
    principalName: String(
      formData.get("principalName") ?? "",
    ),
    registrationInfo: String(
      formData.get("registrationInfo") ?? "",
    ),
  });
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Configure the information that identifies this
              school throughout the system.
            </p>
          </div>
          ...
          {canEdit ? (
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-1 font-semibold text-slate-900">
                  {school?.principalName || "Not configured"}
                </p>
              </div>
